...
|    Key    |    Valor    |
|-----------------------|-----------------------|
|    `com.microsoft.intune.mam.managedbrowser.disabledFeatures`    |    **password** deshabilitará los mensajes que ofrecen la posibilidad de guardar contraseñas para el usuario final.    |
