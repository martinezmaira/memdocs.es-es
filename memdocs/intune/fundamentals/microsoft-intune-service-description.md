...
description: Microsoft Intune es un servicio basado en la nube que facilita la administración de dispositivos Windows, iOS/iPadOS, Mac OS X y Android.
keywords: ''
author: dougeby
ms.author: dougeby
manager: dougeby
