...
* **iOS**
  * [Uso de un dispositivo iOS/iPadOS con Intune](../user-help/using-your-ios-device-with-intune.md)
  * [Cómo obtienen sus aplicaciones los usuarios de iOS/iPadOS](end-user-apps-ios.md)

* **Windows**
  * [Uso de un dispositivo Windows con Intune](../user-help/using-your-windows-device-with-intune.md)
