...
|Actualizado para iOS/iPadOS|Anteriormente para iOS/iPadOS|   
|---|---|   
|![Imagen de Portal de empresa para iOS/iPadOS, con los iconos actualizados resaltados en el menú inferior.](./media/whats-new-app-ui/company-portal-ios-icons-after-2005.png)|![Imagen de Portal de empresa para iOS, con los iconos anteriores resaltados.](./media/whats-new-app-ui/company-portal-ios-icons-before-2005.png)| 

|Actualizado para macOS|  
|---|
|![Imagen de Portal de empresa para macOS, pestaña Dispositivos, con los iconos actualizados resaltados.](./media/whats-new-app-ui/company-portal-macos-icons-after-2005.png)|  
...
![Imagen de ejemplo del mensaje de la pestaña Dispositivos del Portal de empresa para abrir la versión con distintivo de Google Play.](./media/whats-new-app-ui/updated-banner-android-2005.png)  
...
### <a name="improved-macos-enrollment-experience-in-company-portal----5074349-wnready---"></a>Experiencia mejorada de inscripción de macOS en el Portal de empresa <!-- 5074349 WNready -->  
...
### <a name="new-end-user-app-microsoft-intune-app---3903244---"></a>Nueva aplicación de usuario final (aplicación de Microsoft Intune) <!--3903244 -->  
...
### <a name="new-app-categories-screen-in-the-company-portal-app-for-windows-10---3834780-wnready4review---"></a>Nueva pantalla de categorías de aplicaciones en la aplicación Portal de empresa para Windows 10<!-- 3834780 WNready4Review -->  
...
### <a name="intune-mobile-application-management-mam-dialog-boxes-will-have-a-modern-interface----1199015---"></a>Los cuadros de diálogo de administración de aplicaciones móviles (MAM) de Intune tendrán ahora una interfaz moderna <!-- 1199015 -->
...
### <a name="new-user-experience-for-the-company-portal-app-for-android---621622-announced-1702--"></a>Nueva experiencia del usuario en la aplicación Portal de empresa para Android <!--621622, announced 1702-->
