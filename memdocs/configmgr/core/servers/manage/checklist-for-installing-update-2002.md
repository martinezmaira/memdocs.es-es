---
title: Lista de comprobación de 2002
titleSuffix: Configuration Manager
description: Sepa lo que debe hacer antes de actualizar a la versión 2002 de Configuration Manager.
ms.date: 04/01/2020
...
ms.locfileid: "81708063"
---
# <a name="checklist-for-installing-update-2002-for-configuration-manager"></a>Lista de comprobación para la instalación de la actualización 2002 de Configuration Manager

*Se aplica a: Configuration Manager (rama actual)*

Si usa la rama actual de Configuration Manager, puede instalar la actualización en consola de la versión 2002 a fin de actualizar la jerarquía desde una versión anterior. <!-- baseline only statement:-->La versión 2002 también está disponible como [medio de línea base](updates.md#bkmk_Baselines), por lo que puede usar el medio de instalación para instalar el primer sitio de una jerarquía nueva.

Para obtener la actualización de la versión 2002, debe usar un punto de conexión de servicio en el sitio de nivel superior de la jerarquía. Este rol de sistema de sitio puede realizarse en el modo en línea o sin conexión. Para descargar la actualización cuando el punto de conexión de servicio está desconectado, [use la herramienta de conexión de servicio](use-the-service-connection-tool.md).<!-- SCCMDocs#1946 -->
...
- Cuando la actualización aparezca como **Disponible**, ya está lista para instalarse. Antes de instalar la versión 2002, revise la siguiente información [relativa a la instalación de la actualización 2002](#about-installing-update-2002) y la [lista de comprobación](#checklist) para ver las configuraciones que se deben realizar antes de iniciar la actualización.
...
[Script de participación en la versión 2002](https://go.microsoft.com/fwlink/?linkid=2099733) <!-- This fwlink points to the script package on the Download Center, don't change the link here! Make any changes to the fwlink target -->

Microsoft firma el script digitalmente y lo agrupa dentro de un archivo ejecutable autoextraíble.

> [!Note]  
> La actualización de la versión 2002 solo es válida en sitios que ejecutan la versión 1810 u otra posterior.

Para participar en el anillo de actualización inicial:

1. Abra Windows PowerShell y **Ejecutar como administrador**.
1. Ejecute el script **EnableEarlyUpdateRing2002.ps1** con la siguiente sintaxis:

    `EnableEarlyUpdateRing2002.ps1 <SiteServer_Name> | SiteServer_IP>`

    Donde `SiteServer` hace referencia al sitio de administración central o al servidor de sitio primario independiente. Por ejemplo, `EnableEarlyUpdateRing2002.ps1 cmprimary01`.
...
Ahora, la actualización de la versión 2002 debería estar disponible en la consola.

> [!Important]  
> Este script solo agrega el sitio al anillo de actualización inicial de la versión 2002. No se trata de un cambio permanente.
...
Para poder iniciar la instalación de la actualización 2002, cada servidor de sitio de la jerarquía debe ejecutar la misma versión de Configuration Manager. Para actualizar a 2002, debe usar la versión 1810 o una posterior.
...
<!--SCCMdocs#587-->
Si amplía Configuration Manager con otros productos de Microsoft o de partners de Microsoft, confirme que son compatibles con la versión 2002. Para ello, consulte al proveedor del producto. Por ejemplo, vea las [notas de la versión](../../../mdt/release-notes.md) de Microsoft Deployment Toolkit.
...
Para ejecutar una comprobación de requisitos previos desde la consola, vaya al área de trabajo **Administración** y seleccione **Actualizaciones y mantenimiento**. Seleccione el paquete de actualización **Configuration Manager 2002** y haga clic en **Ejecutar comprobación de requisitos previos** en la cinta.
...
Si usa extensiones en Configuration Manager, actualícelas a la versión más reciente para admitir la versión 2002 de Configuration Manager.
