---
title: Lista de comprobación de 1810
titleSuffix: Configuration Manager
description: Obtenga información sobre las acciones que se deben realizar antes de actualizar a la versión 1810 de Configuration Manager.
ms.date: 02/28/2019
...
## <a name="about-installing-update-1810"></a>Acerca de la instalación de la actualización 1810

#### <a name="sites"></a>Sitios
La actualización 1810 se instala en el sitio de nivel superior de la jerarquía. Inicie la instalación desde el sitio de administración central, o bien desde el sitio principal independiente. Después de instalar la actualización en el sitio de nivel superior, los sitios secundarios tienen el siguiente comportamiento de actualización:
...
Cada servidor de sitio de la jerarquía debe ejecutar la misma versión de Configuration Manager antes de iniciar la instalación de la actualización 1810. Para actualizar a 1810, debe usar la versión 1710, 1802 o 1806.
...
<!--SCCMdocs#587-->
Si amplía Configuration Manager con otros productos de Microsoft o de asociados de Microsoft, confirme que sean compatibles con la versión 1810. Para ello, consulte al proveedor del producto. Por ejemplo, vea las [notas de la versión](../../../mdt/release-notes.md) de Microsoft Deployment Toolkit.
...
Para ejecutar una comprobación de requisitos previos desde la consola, vaya al área de trabajo **Administración** y seleccione **Actualizaciones y mantenimiento**. Seleccione el paquete de actualización **Configuration Manager 1810** y haga clic en **Ejecutar comprobación de requisitos previos** en la cinta.
...
Si usa extensiones para Configuration Manager, actualícelas a la versión más reciente para la compatibilidad con la versión 1810 de Configuration Manager. 
