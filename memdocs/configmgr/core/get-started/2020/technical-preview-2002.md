...
description: Conozca las nuevas características disponibles en la versión 2002 de la rama Technical Preview de Configuration Manager.
ms.date: 02/13/2020
...
ms.locfileid: "88995725"
---
# <a name="features-in-configuration-manager-technical-preview-version-2002"></a>Características de la versión 2002 de Technical Preview de Configuration Manager

*Se aplica a: Configuration Manager (rama Technical Preview)*

En este artículo se presentan las características disponibles en la versión 2002 de Technical Preview de Configuration Manager. Instale esta versión para actualizar y agregar características nuevas a su sitio de Technical Preview.
...
## <a name="general-known-issues"></a>Problemas conocidos generales
