...
description: Conozca las nuevas características disponibles en la versión 2001 de la rama Technical Preview de Configuration Manager.
ms.date: 01/17/2020
...
ms.locfileid: "81691743"
---
# <a name="features-in-configuration-manager-technical-preview-version-2001"></a>Características de la versión 2001 de Technical Preview de Configuration Manager

*Se aplica a: Configuration Manager (rama Technical Preview)*

En este artículo se presentan las características disponibles en Technical Preview 2001 de Configuration Manager. Instale esta versión para actualizar y agregar características nuevas a su sitio de Technical Preview.
