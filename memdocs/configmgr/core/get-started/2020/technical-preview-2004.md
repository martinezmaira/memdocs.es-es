...
description: Conozca las nuevas características disponibles en la versión 2004 de la rama Technical Preview de Configuration Manager.
ms.date: 04/30/2020
...
ms.locfileid: "87997946"
---
# <a name="features-in-configuration-manager-technical-preview-version-2004"></a>Características de la versión 2004 de Technical Preview de Configuration Manager

*Se aplica a: Configuration Manager (rama Technical Preview)*

En este artículo se presentan las características disponibles en la versión 2004 de Technical Preview de Configuration Manager. Instale esta versión para actualizar y agregar características nuevas a su sitio de Technical Preview.
