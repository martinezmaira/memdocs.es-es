...
description: Conozca las características nuevas disponibles en la versión 1912 de la rama Technical Preview de Configuration Manager.
ms.date: 12/12/2019
...
ms.locfileid: "82729316"
---
# <a name="features-in-configuration-manager-technical-preview-version-1912"></a>Características de la versión 1912 de Technical Preview de Configuration Manager

*Se aplica a: Configuration Manager (rama Technical Preview)*

En este artículo se presentan las características disponibles en la versión 1912 de Technical Preview de Configuration Manager. Instale esta versión para actualizar y agregar características nuevas a su sitio de Technical Preview.
