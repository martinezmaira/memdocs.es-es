...
Si su sitio de Configuration Manager estaba conectado con Upgrade Readiness, tiene que quitarlo y volver a configurar los clientes. Para obtener más información, vea [Quitar la conexión con Upgrade Readiness](upgrade-readiness.md#bkmk_remove).
