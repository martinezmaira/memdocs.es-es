...
A partir de la versión 1910 de Configuration Manager, puede usar esta versión con cualquier actualización acumulativa, siempre y cuando dicha versión sea compatible con el ciclo de vida de SQL.
