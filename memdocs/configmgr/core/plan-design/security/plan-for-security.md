...
- [Implementación de aplicaciones disponibles para el usuario](../../../apps/deploy-use/deploy-applications.md#deploy-user-available-applications)
...
Para obtener más información sobre Azure AD, vea la [documentación de Azure Active Directory](/azure/active-directory/).
