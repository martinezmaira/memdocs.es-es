---
title: Datos de diagnóstico y uso en la versión 2006
titleSuffix: Configuration Manager
description: Obtenga más información sobre los datos específicos de cada nivel que recopila Configuration Manager en la versión 2006.
ms.date: 08/11/2020
...
ms.locfileid: "88129619"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>Datos de diagnóstico y uso en la versión 2006
...
En el caso de la versión 2006 de Configuration Manager, este nivel incluye los siguientes datos:
...
- Datos básicos de la jerarquía del sitio de Configuration Manager: lista de sitios, tipo, versión, estado, número de clientes, zona horaria y estado de mantenimiento
...
- Información sobre el estado del sitio

- Ubicaciones de bloqueos de la consola de Configuration Manager

- Estadísticas de uso de la consola de Configuration Manager

- Acciones de conexión y desconexión a la nube

- Estado de la última sincronización con el servicio en la nube de Intune

- Recuento de errores del servicio de administración

- Uso del token de registro masivo

- Recuento de clientes mediante el explorador predeterminado y preferido

- ***[Movido]*** Configuración y estadísticas de uso de Cloud Management Gateway: recuentos de regiones y entornos, y estadísticas de autenticación y autorización.  

- ***[Movido]*** Estado de mantenimiento, uso e información de réplica de SQL AlwaysOn  

- ***[Nuevo]*** Configuración y estado de las notificaciones de la consola de administración

- ***[Nuevo]*** Configuración y estado de la comprobación de mantenimiento del sitio
...
- Estadísticas acumuladas sobre los complementos de Office, el uso de Office Readiness Toolkit y los recuentos de clientes con Aplicaciones de Microsoft 365
...
- Número de dispositivos de Office Pro Plus que envían datos del estado de Office
...
- ***[Actualizado]*** - ***[Nuevo]*** Reglas de inventario de software, reglas de recopilación de archivos y estado de mantenimiento general
...
- ***[Nuevo]*** Recuento resumido de eventos de análisis de puntos de conexión
...
- Uso del asistente para la incorporación de servicios en la nube
...
- ***[Nuevo]*** Recuento de la configuración de cumplimiento implementada por categoría, sistema operativo y origen (nube frente a local)
...
- Información de rendimiento de la consola

- 25 acciones más comunes, asistentes, hojas de propiedades y nodos de árbol a los que se puede acceder desde la consola
...
- Recuento de subredes excluidas de la caché del mismo nivel
...
- Estadísticas acumuladas para las directivas de Protección contra amenazas avanzada de Microsoft Defender
...
- Recuento de actualizaciones de Aplicaciones de Microsoft 365 implementadas  
...
- Uso de un grupo de orquestación

- Opciones de configuración de reserva de Windows Update
...
- Estado de las solicitudes de reinicialización recientes
...
- Recuento de clientes con uso del explorador
