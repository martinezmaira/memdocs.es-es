...
description: Obtenga información sobre los niveles de datos de diagnóstico y uso que se recopilan en la versión 1606 de Configuration Manager.
ms.date: 12/29/2016
...
##  <a name="level-1---basic"></a><a name="bkmk_level1"></a> Nivel 1: Básico
 ...
 A partir de la versión 1606 de Configuration Manager, este nivel incluye lo siguiente:
...
-   ***[Nuevo]*** Módulo de configuración de DCM para el uso de Configuration Manager
