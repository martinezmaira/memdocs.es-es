---
title: Datos de diagnóstico y de uso en la versión 1910
titleSuffix: Configuration Manager
description: Obtenga más información sobre los datos específicos de cada nivel que recopila Configuration Manager en la versión 1910.
ms.date: 11/29/2019
...
En el caso de la versión 1910 de Configuration Manager, este nivel incluye los siguientes datos:
...
- ***[Nuevo]*** Recuento de instalaciones de Microsoft Edge
...
- ***[Nuevo]*** Recuento y tamaño de las recopilaciones piloto de Office Pro Plus
...
- ***[Nuevo]*** Recuento de carpetas

- ***[Nuevo]*** Uso de la herramienta de migración de Azure
